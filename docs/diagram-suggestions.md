...
- [x] Add a wheel or cyclical diagram mapping "Plan → Improve → Engage → Design & Transition → Obtain/Build → Deliver & Support" with arrows to show continual improvement and feedback loops across activities. *Completed: Added to content/part-01/value-chain/slides.html*
