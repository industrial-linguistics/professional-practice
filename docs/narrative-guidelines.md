...
You may indicate delivery style with bracketed notes, e.g. `[excitedly]`, and split the script between "Speaker 1" and "Speaker 2" if you want a dialog. Speaker labels are metadata for voice selection; they should not be spoken in the rendered audio. Keep the tone friendly and feel free to use analogies, humour and real-world examples to hold the listener's attention.
