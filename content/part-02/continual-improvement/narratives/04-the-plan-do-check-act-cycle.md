...
Speaker 1: Do is implementing your solution, but start small. Roll out that self-service portal to one department first, not the entire organisation. This lets you test and learn without major disruption.
...
Speaker 1: Act is where you decide what to do next. If the pilot worked well, standardise it across the organisation. If it didn't, learn from what went wrong and try a different approach. The cycle then begins again.
