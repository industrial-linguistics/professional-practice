...
- the organisation's purpose, users, constraints and decision rights;
- a service model showing technology, people, suppliers and hand-offs;
- intake, support, escalation, incident and change processes;
- a delivery approach and a small set of measures that can drive improvement;
- vendor, licence and renewal assumptions;
- a security and privacy baseline proportionate to the organisation;
- a year-three operating cost, not merely an implementation price;
- a data-authority position that states who decides about collection, access, reuse and disposal;
- major risks, rejected alternatives and the evidence that would change the recommendation.
...
## Build For A Mixed Review Panel
...
## Run The Design Work In Deliberate Passes
...
## Turn The Result Into A Portfolio Artefact
