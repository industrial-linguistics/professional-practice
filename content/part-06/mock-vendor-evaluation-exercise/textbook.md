...
## Score it like you'll have to defend it
...
When reviewing the result, weight the memo and the traceability of the scorecard far above the "right" vendor choice: a well-argued Intercom recommendation loses nothing to a well-argued Zendesk one. Reject unevidenced scores, risks without owners and pitches the observer could not retell. The practical test is simple: when this team spends real money in six months, will the paper trail explain why?
