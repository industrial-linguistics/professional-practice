...
To apply the model, draft a day-zero checklist for a hypothetical startup and mark explicitly where outside experts (lawyer, accountant, MSP) are required rather than optional.
